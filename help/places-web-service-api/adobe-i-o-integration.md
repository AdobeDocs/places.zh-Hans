...
>[!IMPORTANT]
>
>如果您无法登录到Adobe I/O控制台，或者如果“创建集成”页面上不提供Experience Platform Location Service *，请参阅* Places web服务概述中的组 *织要* 求 [](/help/places-web-service-api/places-web-services.md)。
